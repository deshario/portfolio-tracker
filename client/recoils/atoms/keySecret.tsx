  ...
  return {
    ...
    getItem: (key: any) => {
      ...
      if (credentials != null) {
        ...
        parsedCredentials.keySecret.btKey = decrypt(
          parsedCredentials.keySecret.btKey,
        )
        parsedCredentials.keySecret.btSecret = decrypt(
          parsedCredentials.keySecret.btSecret,
        )
